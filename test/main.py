...
import time
import pymht
from pymht.classDefinitions import Position
import pymht.radarSimulator as sim
import pymht.helpFunctions as hpf
from pymht.stateSpace.pv import*
...
def runSimulation(**kwargs):
	...
	tracker = pymht.Tracker(Phi, C, Gamma, P_d, P0, R(), Q, lambda_phi, lambda_nu, eta2, N, "CPLEX", logTime = True)
...
if __name__ == '__main__':
	...
	profile.run("runSimulation(plot = False)", sort = "time")
	# runSimulation()
	# print("Done :)")
